...
async function main() {
    ...
    const registry = new vsctm.Registry({
        ...
        loadGrammar: async (scopeName) => {
            ...
            if (scopeName === 'source.js') {
                jsGrammarLoaded = true;
                return null; // Simulate missing JS grammar
            }
            return null;
        }
    });
    ...
    console.log('\nJS grammar was requested:', jsGrammarLoaded);
...
%>`;
    ...
    console.log("\nTesting EJS grammar with multi-line code (no JS grammar):\n");
